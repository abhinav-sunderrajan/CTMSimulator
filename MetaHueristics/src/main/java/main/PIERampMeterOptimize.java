...
public class PIERampMeterOptimize {
	...
	public static void main(String args[]) throws InterruptedException {
		...
		Map<Integer, Road> pieChangi = SimulatorCore.getPieChangi();
		...
		for (Entry<List<Double>, Integer> entry : pieOptimize.populationFitnessMap.entrySet()) {
			...
			CellTransmissionModel ctmBestConfig = new CellTransmissionModel(pieChangi.values(),
					false, true, false, true, 900);
			List<Double> queuePercentages = entry.getKey();
			int index = 0;
